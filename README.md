...
# Склоняем имя и фамилию (срезаем последнюю букву, добавляем окончание)
name = names[idx][:-1] + "я"
surname = last_names[idx] + "а"

# Выводим текст построчно, как в примере
print(f"Уважаемые родители {name} {surname}!")
print("Приглашаем вас на родительское собрание, которое состоится 26 сентября в 19:00.")
print()
print("С уважением,")
